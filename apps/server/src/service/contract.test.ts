...
process.env.DATABASE_URL ??= "postgres://postgres:workloom@localhost:5432/panda_cineforge";
process.env.DATABASE_APP_URL ??= "postgres://workloom_app:workloom_dev_app@localhost:5432/panda_cineforge";
process.env.DATABASE_GATEWAY_URL ??= "postgres://workloom_gateway:workloom_dev_gateway@localhost:5432/panda_cineforge";

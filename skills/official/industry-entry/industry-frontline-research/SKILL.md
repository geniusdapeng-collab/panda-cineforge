...
- 已有行业Bundle需要深化某个业务域时（如电商版的"售后域"需要深化）
...
**场景二：特定业务域深化**
电商行业的"售后域"需要深化——买家下单后的每个触点、每个服务环节、每个可能的AI增强机会，需要更细粒度的调研。

**场景三：无人业态特殊场景调研**
无人零售、无人餐厅、无人仓储等新业态，需要分析其"全流程自动化中的断点"和"兜底方案"。
...
**还原步骤**：
1. **特殊业态识别**：这个行业有哪些特殊业态？（如零售的无人便利店、餐饮的无人餐厅）
...
5. **特殊业态的AI增强流程设计**：针对特殊业态，设计完整的AI增强流程（如无人便利店的夜班班组+远程管理）。
...
|--------|------|------|
| 目标行业 | 要调研的行业名称 | 调用者指定 |
| 目标客群 | 要调研的客群类型（如单平台腰部卖家/国内大卖/跨境集团） | 调用者指定 |
| 一线角色清单 | 要调研的一线角色（如店长/运营/客服专员） | 调用者指定或本技能识别 |
...
4. **行业特定调整**：根据行业特点，调整某些层级的还原重点（如餐饮的"角色全景"要包含后厨厨师，电商的"角色全景"包含客服专员）

### 7.3 已验证的行业

- ✅ 电商行业（店长/运营/客服专员调研，已验证框架可行性）
- 🔜 餐饮行业（店长/前厅/后厨调研，待执行）
- 🔜 美业行业（店长/前台/技师调研，待执行）
...
| 服务交付一线 | 客服专员 | 后厨厨师 | 技师 | 教师 |
| 双一线协作 | 运营+客服 | 前厅+后厨 | 前台+技师 | 前台+教师 |
...
| 版本 | 日期 | 变更 |
|------|------|------|
| v1.0 | 2026-08-20 | 初始版本，基于电商行业一线作业调研实践抽象 |
